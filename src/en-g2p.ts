...
export class EnglishG2P implements LanguageProcessor {
  ...
  private predictInternal(
    ...
    if (syllableIPA.length > 0) {
      ...
      result = result.replace(/ɑl([dtsk])/g, 'oʊl$1');  // ol+d/t/s/k across syllable: beholden/bolton/bolster/colson/holcomb

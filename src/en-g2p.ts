...
export class EnglishG2P implements LanguageProcessor {
  ...
  private predictInternal(
    ...
    if (syllableIPA.length > 0) {
      ...
      result = result.replace(/oʊɹ/g, 'ɔɹ');  result = result.replace(/[ɑə][ɛə]$/, 'oʊ');  result = result.replace(/oʊ([ntplm])ɪk/g, 'ɑ$1ɪk');  result = result.replace(/oʊnəm/g, 'ɑnəm');  result = result.replace(/oʊmɪtɝ/g, 'ɑmɪtɝ');  // o-open-syllable before r; -oe; -onic/-opic/-olic/-omic/-otic; -onomy; -ometer (chronic/asymptotic/astronomer/barometer)
